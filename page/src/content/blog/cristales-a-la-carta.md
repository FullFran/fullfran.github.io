...
Y ninguna tiene absorción haciendo el trabajo. El color no es un tinte, es interferencia: el mismo fenómeno que dos altavoces cancelándose en una habitación, solo que ocurriendo quinientos billones de veces por segundo.

## El problema

Planteado del todo, que es como hay que plantearlo antes de tocar nada.

Tienes N capas paralelas, cada una con su índice de refracción (cuánto frena la luz ese material) y su espesor. Llega una onda plana desde fuera, con un ángulo y una longitud de onda. ¿Qué fracción de la potencia se vuelve por donde vino, y qué fracción atraviesa?

Eso es todo. Esas dos fracciones se llaman R y T, y con ellas se acaba el problema directo entero. Que tiene un hermano bastante más divertido, y al que llegaré al final.
...
¿Y qué pasa si eliges la rama equivocada? Que la conservación de la energía se te sigue cumpliendo perfectamente. Todos los tests en verde. Simplemente estás simulando un medio que amplifica la luz.
